...
mod tests {
    use algorithms_edu::{
        ...
        string::suffix_array::{huo2016::Huo2016, SuffixArray},
    };
    ...
    fn bench_huo(b: &mut Bencher, sigma: u32, len: usize) {
        b.iter(|| {
            black_box({
                let mut s = random_uniform_vec(1, sigma, len);
                s.push(0);
    ...
    #[bench]
    fn bench_huo_500_1000(b: &mut Bencher) {
        bench_huo(b, 500, 1000);
    }
    #[bench]
    fn bench_huo_500_10000(b: &mut Bencher) {
        bench_huo(b, 500, 10000);
    }
    #[bench]
    fn bench_huo_500_100000(b: &mut Bencher) {
        bench_huo(b, 500, 100000);
    }
    #[bench]
    fn bench_huo_500_1000000(b: &mut Bencher) {
        bench_huo(b, 500, 1000000);
    }
...
// Sample result
// test tests::bench_huo_500_1000      ... bench:     168,711 ns/iter (+/- 27,549)
// test tests::bench_huo_500_10000     ... bench:   1,356,838 ns/iter (+/- 79,133)      x 8.0  x   8.0
// test tests::bench_huo_500_100000    ... bench:  14,359,321 ns/iter (+/- 1,307,696)   x10.6  x  85.1
// test tests::bench_huo_500_1000000   ... bench: 180,594,903 ns/iter (+/- 13,631,112)  x12.6  x1070.4
